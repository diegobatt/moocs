...
function $s_s_Function2$class__tupled__F2__F1($$this) {
...
function $s_sc_TraversableOnce$class__count__sc_TraversableOnce__F1__I($$this, p) {
...
$c_Lcalculator_CalculatorUI$.prototype.parseSimple$1__p1__T__Lcalculator_Expr = (function(text) {
  ...
  if ((jsx$3 === $uI($$this$1.length))) {
    ...
    try {
      ...
      return new $c_Lcalculator_Literal().init___D(jsx$4.parseDouble__T__D($$this$2))
    } catch (e) {
...
$c_Lcalculator_CalculatorUI$.prototype.parseExpr__T__Lcalculator_Expr = (function(text) {
  ...
  while ((i < len)) {
    ...
    var x$3 = $as_T(arg1);
    var elem = $as_T(x$3.trim());
    var unboxedElem = ((elem === null) ? null : elem);
    elems$2.push(unboxedElem);
    i = ((1 + i) | 0)
  };
  var xs$1 = $makeNativeArrayWrapper($d_T.getArrayOf(), elems$2);
  var b = new $c_scm_ArrayBuilder$ofRef().init___s_reflect_ClassTag(new $c_s_reflect_ClassTag$ClassClassTag().init___jl_Class($d_T.getClassOf()));
  var i$1 = 0;
  ...
  var x1 = $asArrayOf_T(b.result__AO(), 1);
  ...
  if ((!o10.isEmpty__Z())) {
    if (((o10.get__O() !== null) && ($as_sc_SeqLike(o10.get__O()).lengthCompare__I__I(3) === 0))) {
      ...
      var b$1 = this.parseSimple$1__p1__T__Lcalculator_Expr(bText);
      if ((op === "+")) {
        return new $c_Lcalculator_Plus().init___Lcalculator_Expr__Lcalculator_Expr(a, b$1)
      } else if ((op === "-")) {
        return new $c_Lcalculator_Minus().init___Lcalculator_Expr__Lcalculator_Expr(a, b$1)
      } else if ((op === "*")) {
        return new $c_Lcalculator_Times().init___Lcalculator_Expr__Lcalculator_Expr(a, b$1)
      } else if ((op === "/")) {
        return new $c_Lcalculator_Divide().init___Lcalculator_Expr__Lcalculator_Expr(a, b$1)
      } else {
...
$c_Lcalculator_CalculatorUI$.prototype.setupCalculator__V = (function() {
  ...
  var names = b.result__sci_Vector();
  $m_sci_IndexedSeq$();
  var bf$1 = $m_sc_IndexedSeq$().ReusableCBF$6;
  var b$1 = $s_sc_TraversableLike$class__builder$1__p0__sc_TraversableLike__scg_CanBuildFrom__scm_Builder(names, bf$1);
  var this$14 = names.iterator__sci_VectorIterator();
  while (this$14.$$undhasNext$2) {
    var arg1$1 = this$14.next__O();
    var name = $as_T(arg1$1);
    b$1.$$plus$eq__O__scm_Builder($m_Lcalculator_CalculatorUI$().elementById__T__sjs_js_Any(("calculatorexpr" + name)))
  };
  var inputs = $as_sci_IndexedSeq(b$1.result__O());
  ...
  var expr = new $c_sjsr_AnonFunction0().init___sjs_js_Function0((function(text$1, parent$1) {
    return (function() {
      ...
      try {
        ...
        return jsx$2.parseDouble__T__D($$this)
      } catch (e) {
        if ($is_jl_NumberFormatException(e)) {
          $as_jl_NumberFormatException(e);
...
$c_Lcalculator_Polynomial$.prototype.positive$1__p1__Lcalculator_Signal__Lcalculator_Signal__Lcalculator_Signal__D = (function(a$2, b$2, delta$2) {
  var jsx$1 = $uD(b$2.apply__O());
  var x = $uD(delta$2.apply__O());
  return ((-jsx$1) + ($uD($g.Math.sqrt(x)) / (2 * $uD(a$2.apply__O()))))
});
$c_Lcalculator_Polynomial$.prototype.computeSolutions__Lcalculator_Signal__Lcalculator_Signal__Lcalculator_Signal__Lcalculator_Signal__Lcalculator_Signal = (function(a, b, c, delta) {
  $m_Lcalculator_Signal$();
  var expr = new $c_sjsr_AnonFunction0().init___sjs_js_Function0((function(a$2, b$2, delta$2) {
    return (function() {
      return $m_Lcalculator_Polynomial$().calculator$Polynomial$$logic$1__Lcalculator_Signal__Lcalculator_Signal__Lcalculator_Signal__sci_Set(a$2, b$2, delta$2)
    })
  })(a, b, delta));
  return new $c_Lcalculator_Signal().init___F0(expr)
});
$c_Lcalculator_Polynomial$.prototype.calculator$Polynomial$$logic$1__Lcalculator_Signal__Lcalculator_Signal__Lcalculator_Signal__sci_Set = (function(a$2, b$2, delta$2) {
  if (($uD(delta$2.apply__O()) < 0)) {
    return $as_sci_Set($m_s_Predef$().Set$2.apply__sc_Seq__sc_GenTraversable($m_sci_Nil$()))
  } else {
    var array = [this.positive$1__p1__Lcalculator_Signal__Lcalculator_Signal__Lcalculator_Signal__D(a$2, b$2, delta$2), this.negative$1__p1__Lcalculator_Signal__Lcalculator_Signal__Lcalculator_Signal__D(a$2, b$2, delta$2)];
...
$c_Lcalculator_Polynomial$.prototype.calculator$Polynomial$$delta$1__Lcalculator_Signal__Lcalculator_Signal__Lcalculator_Signal__D = (function(a$1, b$1, c$1) {
  return (($uD(b$1.apply__O()) * $uD(b$1.apply__O())) - ((4 * $uD(a$1.apply__O())) * $uD(c$1.apply__O())))
});
$c_Lcalculator_Polynomial$.prototype.negative$1__p1__Lcalculator_Signal__Lcalculator_Signal__Lcalculator_Signal__D = (function(a$2, b$2, delta$2) {
  var jsx$1 = $uD(b$2.apply__O());
  var x = $uD(delta$2.apply__O());
  return ((-jsx$1) - ($uD($g.Math.sqrt(x)) / (2 * $uD(a$2.apply__O()))))
});
$c_Lcalculator_Polynomial$.prototype.computeDelta__Lcalculator_Signal__Lcalculator_Signal__Lcalculator_Signal__Lcalculator_Signal = (function(a, b, c) {
  ...
  var expr = new $c_sjsr_AnonFunction0().init___sjs_js_Function0((function(a$1, b$1, c$1) {
    return (function() {
      return $m_Lcalculator_Polynomial$().calculator$Polynomial$$delta$1__Lcalculator_Signal__Lcalculator_Signal__Lcalculator_Signal__D(a$1, b$1, c$1)
    })
  })(a, b, c));
  return new $c_Lcalculator_Signal().init___F0(expr)
});
...
$c_Lcalculator_Signal.prototype.apply__O = (function() {
  this.calculator$Signal$$observers$1 = $as_sci_Set(this.calculator$Signal$$observers$1.$$plus__O__sc_Set($m_Lcalculator_Signal$().caller$1.v$1));
  var assertion = (!$as_Lcalculator_Signal($m_Lcalculator_Signal$().caller$1.v$1).calculator$Signal$$observers$1.contains__O__Z(this));
  if ((!assertion)) {
  ...
  var this$2 = ev$1.observed$1;
  ev$1.observed$1 = new $c_sci_$colon$colon().init___O__sci_List(this, this$2);
...
$c_Lcalculator_TweetLength$.prototype.calculator$TweetLength$$tweetLength__T__I = (function(text) {
  ...
  if ((text === "")) {
    ...
    var jsx$3 = $uI(text.length);
    var this$4 = new $c_sci_StringOps().init___T(text);
    var x = $as_T($s_sc_IndexedSeqOptimized$class__init__sc_IndexedSeqOptimized__O(this$4));
    var this$9 = new $c_sci_StringOps().init___T(x);
    var jsx$2 = $m_s_Predef$();
    var this$7 = new $c_sci_StringOps().init___T(text);
    var that = jsx$2.wrapString__T__sci_WrappedString($as_T($s_sc_IndexedSeqOptimized$class__tail__sc_IndexedSeqOptimized__O(this$7)));
    var this$8 = $m_s_Predef$();
    var bf = new $c_s_LowPriorityImplicits$$anon$4().init___s_LowPriorityImplicits(this$8);
    var jsx$1 = $as_sc_TraversableOnce($s_sc_IndexedSeqOptimized$class__zip__sc_IndexedSeqOptimized__sc_GenIterable__scg_CanBuildFrom__O(this$9, that, bf));
    ...
    return ((jsx$3 - jsx$1.count__F1__I($s_s_Function2$class__tupled__F2__F1(this$15))) | 0)
  }
});
...
$c_Lcalculator_TweetLength$.prototype.calculator$TweetLength$$logic$1__Lcalculator_Signal__T = (function(remainingCharsCount$1) {
  return (($uI(remainingCharsCount$1.apply__O()) < 0) ? "red" : (($uI(remainingCharsCount$1.apply__O()) < 15) ? "orange" : "green"))
});
$c_Lcalculator_TweetLength$.prototype.colorForRemainingCharsCount__Lcalculator_Signal__Lcalculator_Signal = (function(remainingCharsCount) {
  ...
  var expr = new $c_sjsr_AnonFunction0().init___sjs_js_Function0((function(remainingCharsCount$1) {
    return (function() {
      return $m_Lcalculator_TweetLength$().calculator$TweetLength$$logic$1__Lcalculator_Signal__T(remainingCharsCount$1)
    })
  })(remainingCharsCount));
  return new $c_Lcalculator_Signal().init___F0(expr)
});
...
/** @constructor */
function $c_Lcalculator_Calculator$$anonfun$computeValues$1() {
  $c_sr_AbstractFunction1.call(this);
...
/** @constructor */
function $h_Lcalculator_Calculator$$anonfun$computeValues$1() {
  /*<skip>*/
}
...
var $d_Lcalculator_Calculator$$anonfun$computeValues$1 = new $TypeData().initClass({
...
/** @constructor */
function $c_Lcalculator_CalculatorUI$$anonfun$2() {
  $c_sr_AbstractFunction1.call(this);
...
/** @constructor */
function $h_Lcalculator_CalculatorUI$$anonfun$2() {
  /*<skip>*/
}
...
var $d_Lcalculator_CalculatorUI$$anonfun$2 = new $TypeData().initClass({
...
/** @constructor */
function $c_Lcalculator_CalculatorUI$$anonfun$setupCalculator$2() {
  $c_sr_AbstractFunction1.call(this)
}
...
/** @constructor */
function $h_Lcalculator_CalculatorUI$$anonfun$setupCalculator$2() {
  /*<skip>*/
}
...
$c_Lcalculator_CalculatorUI$$anonfun$setupCalculator$2.prototype.init___ = (function() {
  return this
});
...
var $d_Lcalculator_CalculatorUI$$anonfun$setupCalculator$2 = new $TypeData().initClass({
...
$c_s_StringContext.prototype.raw__sc_Seq__T = (function(args) {
  ...
  while (ai.hasNext__Z()) {
    ...
    bldr.java$lang$StringBuilder$$content$f = (("" + bldr.java$lang$StringBuilder$$content$f) + obj);
    var arg1$1 = pi.next__O();
    var str = $as_T(f(arg1$1));
    bldr.java$lang$StringBuilder$$content$f = (("" + bldr.java$lang$StringBuilder$$content$f) + str)
  };
  return bldr.java$lang$StringBuilder$$content$f
});
...
/** @constructor */
function $c_Lcalculator_CalculatorUI$$anonfun$setupCalculator$2$$anonfun$apply$1() {
...
/** @constructor */
function $h_Lcalculator_CalculatorUI$$anonfun$setupCalculator$2$$anonfun$apply$1() {
  /*<skip>*/
}
...
var $d_Lcalculator_CalculatorUI$$anonfun$setupCalculator$2$$anonfun$apply$1 = new $TypeData().initClass({
...
$c_scm_ArrayBuilder$ofUnit.prototype.result__Asr_BoxedUnit = (function() {
  if (((this.capacity$2 !== 0) && (this.capacity$2 === this.size$2))) {
    ...
    return this.mkArray__p2__I__Asr_BoxedUnit(this.size$2)
  }
});
...
$c_scm_ArrayOps$ofLong.prototype.toMap__s_Predef$$less$colon$less__sci_Map = (function(ev) {
  ...
  while ((i < len)) {
    var idx = i;
    var $$this$1 = this.repr$1;
    var t = $$this$1.get(idx);
    var lo = t.lo$2;
    var hi = t.hi$2;
    b.$$plus$eq__T2__scm_MapBuilder($as_T2(new $c_sjsr_RuntimeLong().init___I__I(lo, hi)));
    i = ((1 + i) | 0)
  };
  return $as_sci_Map(b.elems$1)
});
...
$c_scm_StringBuilder.prototype.foldLeft__O__F2__O = (function(z, op) {
  return $s_sc_IndexedSeqOptimized$class__foldl__p0__sc_IndexedSeqOptimized__I__I__O__F2__O(this, 0, this.underlying$5.length__I(), z, op)
});
